...
function unionlote(e) {
  ...
  document.getElementById("sslote").innerHTML =
    e.target.feature.properties.cd_lote; // MOSTRA O LOTE SELECIONADO
  document.getElementById("ssbairro").innerHTML =
    e.target.feature.properties.cd_bairro; // MOSTRA O LOTE SELECIONADO
  document.getElementById("ccadastro").innerHTML =
    e.target.feature.properties.dt_cadastr; // MOSTRA O LOTE SELECIONADO
...
function select(e) {
  basequadra[varicntrl] = L.geoJson(L_lote, {
    filter: function (feature, layer) {
      if (
        e.target.feature.properties.cd_quadra == feature.properties.cd_quadra
      ) {
        //FILTRA OS LOTES ESPECIFICOS DA QUADRA SELECIONADA
        return true;
      }
    },
  ...
  layerControl.addOverlay(
    basequadra[varicntrl],
    "Lote " + e.target.feature.properties.cd_quadra
  ); //ADICIONA OS LOTES DA QUADRA AO CONTROLE DO MAPA
