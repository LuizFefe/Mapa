      ...
      (L.drawLocal = {
        draw: {
          toolbar: {
            ...
            undo: { title: "Apagar último ponto inserido", text: "Apagar último ponto" },
            buttons: {
              polyline: "Draw a polyline",
              //polygon: "Draw a polygon",
              polygon: "Desenhe o poligono",
          ...
          handlers: {
            ...
            polygon: {
              tooltip: {
                ...
                cont: "Clique para continuar o desenho.",
                end: "Clique no primeiro ponto para fechar o ponto."
              }
            },
            polyline: {
        ...
        edit: {
          ...
          handlers: {
            edit: {
              tooltip: {
                text: "Arraste os ponto para alterar o desenho.",
                subtext: "Clique em cancelar para desfazer as alterações."
              }
            },
            remove: { tooltip: { text: "Clique no desenho para apagar." } }
          }
        }
      }),
      (L.Draw.Event = {}),
